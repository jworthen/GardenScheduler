    ...
    <div className="min-h-screen bg-green-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-lg p-10 w-full max-w-sm text-center">
        <div className="flex items-center justify-center gap-3 mb-2">
          ...
          <span className="text-2xl font-bold text-green-800">Garden Scheduler</span>
        </div>
        <p className="text-gray-500 mt-2 mb-8 text-sm">
          Sign in to save your garden data to the cloud — safe from browser clears, accessible anywhere.
        </p>
